...
from mlpe.architectures.embeddings import ResNet, QuantizedResNet, Simple1DCNN, TCN
...
def main():
    ...
    embedding = Simple1DCNN(num_ifos=n_ifos, context_dim=cnn_context_dim)
    #embedding = TCN(num_ifos=n_ifos, context_dim=cnn_context_dim)
    '''
    embedding = ResNet(
        (n_ifos, strain_dim),
    ...
    torch.save(flow_obj.state_dict(), 'org_cnn_epoch10.pth')
